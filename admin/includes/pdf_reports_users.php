...
if (!$session->is_signed_in() || $current_permissions === "user" || $current_permissions === "tech" || $current_state != 1) {
...
<body>
    <div>
        ...
        <table>
            ...
            <tbody>
                <?php
                $users_list = Users::find_all_users();
...
$fileName = 'usuarios_' . $dateTimeFormatted . '.pdf';
